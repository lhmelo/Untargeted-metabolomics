...
# This function will take two data.frames, X and Y, compute a list of compounds in Y which match X, and then plot each compound individually. This script is configured so that only compounds of Compound.Type "Internal Standard" (and of appropriate polarity and phase) will appear in plotted output.
...
# islotter(PPM = 10, RTRange = 0.3)



isplotter <- function(PPM = 5, RTRange = 0.2){
 ...
 Target.Compounds <- data[which(data[,'Column'] == COLUMN  & 
                                  ...
                                  data[,'Compound.Type']=="Internal Standard"), 
