#getTICs() will plot TICs with colors assigned to particular samples in the January 2017 Prochlorococcus Pellet Sample Set.
...
getTICs <- function(xcmsSet=NULL,files=NULL, pdfname="TICs.pdf",rt=c("raw","corrected")) {
  ...
  for (j in 1:length(FractionList)){
    ...
    QCAppear[grepl("Process" , AllSamples, ignore.case = TRUE) , "Colors"] <- "#CCCCCCFF"
